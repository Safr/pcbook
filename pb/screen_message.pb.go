...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=github.com.safr.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x2e, 0x73, 0x61, 0x66, 0x72, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb1,
	...
	0x32, 0x24, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x61,
	0x66, 0x72, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: github.com.safr.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: github.com.safr.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: github.com.safr.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: github.com.safr.pcbook.Screen.resolution:type_name -> github.com.safr.pcbook.Screen.Resolution
	0, // 1: github.com.safr.pcbook.Screen.panel:type_name -> github.com.safr.pcbook.Screen.Panel

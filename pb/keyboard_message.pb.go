...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=github.com.safr.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x61, 0x66, 0x72, 0x2e,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: github.com.safr.pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: github.com.safr.pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: github.com.safr.pcbook.Keyboard.layout:type_name -> github.com.safr.pcbook.Keyboard.Layout

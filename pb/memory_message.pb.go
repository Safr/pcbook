...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=github.com.safr.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x2e, 0x73, 0x61, 0x66, 0x72, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb7,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: github.com.safr.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: github.com.safr.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: github.com.safr.pcbook.Memory.unit:type_name -> github.com.safr.pcbook.Memory.Unit
